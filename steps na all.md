...
3. Node.JS
   ...
   1. Create Products Backend
      1. Install nodemon globally (its is like node, bt diff is-it check your code changes, if there is any change it re run the project)
      2. Add server.js
      3. Install express body-parser mongoose shortid (to implement the backend need these libraries)
        express     : as web server
        body-parser : to parse the data incide the post request to the servr
        mongoose    : connects us to the mongodb database
        shortid     : to create user friendly ID to save as a productID
      4. Install MongoDB
      5. app = express()
